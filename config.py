...
# --- Поведение AI ---
AI_UPDATE_INTERVAL = 2.0       # Как часто AI принимает решения (в секундах)
PLATFORM_UPDATE_INTERVAL = 5.0 # Как часто сканировать окна на рабочем столе

# --- Конфигурация Обновлений ---
CURRENT_VERSION = "2.1.3.5" # Текущая версия приложения
